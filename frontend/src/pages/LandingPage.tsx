    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex-1">
        <section className="container mx-auto text-center py-20 px-4">
          ...
          <Link to="/signup" className="px-8 py-4 bg-green-600 text-white font-bold rounded-lg text-lg hover:bg-green-700 transition-colors">
            Começar Agora
          </Link>
        </section>
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto text-center">
            ...
            <div className="flex justify-center items-center space-x-4">
              <a href="https://github.com/pablosscosta/" className="text-green-600 hover:text-green-800 font-medium transition-colors" target="_blank" rel="noopener noreferrer">
                Meu GitHub
              </a>
              <span className="text-gray-400">|</span>
              <a href="https://pablosscosta.github.io/portfolio/" className="text-green-600 hover:text-green-800 font-medium transition-colors" target="_blank" rel="noopener noreferrer">
                Meu Portfólio
              </a>
              <span className="text-gray-400">|</span>
              <a href="https://www.linkedin.com/in/pablosilva013/" className="text-green-600 hover:text-green-800 font-medium transition-colors" target="_blank" rel="noopener noreferrer">
                Meu LinkedIn
              </a>
            </div>
          </div>
